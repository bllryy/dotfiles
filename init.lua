...
local config = {
    ...
    theme = {
        --background_png = "/home/lily/Desktop/Reading.png"
    }
}
            ...
            elseif this and not enable then
                ...
                if active_width == width and active_height == height then
                    ...
                    waywall.set_resolution(0, 0)
                        ...
                        local images = {
                            overlay = make_image(
                                "/home/lily/Documents/overlay.png",
                        ...
                        waywall.set_sensitivity(0)
                        waywall.image("/home/chloe/Desktop/Color.png", {dst={x=0, y=0, w=1920, h=480}})
                        show_mirrors(false, false, false, false, false)
                        end
                        ...
                        waywall.exec("java -jar /home/chloe/Desktop/Ninjabrain-Bot-1.5.1.jar")
                        end
